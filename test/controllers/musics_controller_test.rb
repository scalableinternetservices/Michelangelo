...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { artist: @music.artist, comment: @music.comment, hashtag: @music.hashtag, link: @music.link, title: @music.title }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { artist: @music.artist, comment: @music.comment, hashtag: @music.hashtag, link: @music.link, title: @music.title }
    assert_redirected_to music_path(assigns(:music))
  end
